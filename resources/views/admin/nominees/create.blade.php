<x-app-layout>
    ...
    <section class="content">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.award-nominee.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="service_name" name="service_name"
                                    placeholder="Enter Service/ Business Name" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="tel" id="contact_person_phone" name="contact_person_phone"
                                    class="form-control" placeholder="Phone eg: 0*********" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="address" name="address" class="form-control"
                                    placeholder="Enter Business/Service Address" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2bs4" id="verified" name="verified"
                                    ...
                                    @foreach (VerifiedEnum::cases() as $verification)
                                        <option value="{{ $verification->value }}">{{ $verification->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-12">
                            ...
                            <textarea id="description" name="description" class="form-control"
                                placeholder="Short Description About your Business / Services" required rows="5"></textarea>
                        </div>
                    </div>

                    <div class="row">
                        <div class="col-12 mt-3">
                            <button type="submit" class="btn btn-success float-right">Create Nominee</button>
                        </div>
                    </div>
                </form>
            </div>
